                ...
                <div class="collapse navbar-collapse md-6" id="navbarContent">
                    <span class="navbar-text ms-5 container-fluid justify-content-center align-items-center text-center space-between">
                        <div class="md-3" class="links-li-su">               
		                    <a href="login.php"><button class="btn btn-none btn-custom">Iniciar sesión</button></a>
                        </div>
                    </span>
                </div>
            </nav>
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="signupAsSeller.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="name" type="text" id="name" placeholder="Ingrese su nombre" required>
                            </div>
                            <div class="mb-3">
                                <label for="last_name" class="form-label float-left">Apellido</label>
                                <input class="form-control" name="last_name" type="text" id="last_name" placeholder="Ingrese su apellido" required>
                            </div>
                            <div class="mb-3">
                                <label for="identity" class="form-label float-left">N. Identidad</label>
                                <input class="form-control" name="identity" type="number" id="identity" placeholder="Ingrese su numero de cedula" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 justify-content-center align-items-center text-center">
                                <button type="submit" class="form-control btn btn-primary" id="btn-singup">
                                    Registrar
                                </button>
                            </div>
                        </form>
